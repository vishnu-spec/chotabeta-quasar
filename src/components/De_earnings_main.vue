  ...
  data () {
    return {
      ...
      columns: [
        ...
        //   sortable: true
        // },
        { name: 'uid', align: 'center', label: 'Order ID', field: 'uid', sortable: true },
        ...
        { name: 'delivery_boy_name', label: 'DE Name', field: 'delivery_boy_name', sortable: true },
        { name: 'order_status_string', label: 'Order Status', field: 'order_status_string', sortable: true },
        { name: 'current_claim', label: 'Claim By', field: 'current_claim', sortable: true },
        { name: 'vendor_id', label: 'Vendor ID', field: 'vendor_id', sortable: true },
        { name: 'user_id', label: 'User ID', field: 'user_id', sortable: true },
        { name: 'user_name', label: 'User Name', field: 'user_name', sortable: true },
        { name: 'from_location', label: 'From loaction', field: 'from_location', sortable: true },
        { name: 'to_location', label: 'To Location', field: 'to_location', sortable: true },
        { name: 'delivered_at_one', label: 'delivered at one', field: 'delivered_at_one', sortable: true },
        { name: 'actual_schedule_timestamp', label: 'Actual Schedule Timestamp', field: 'actual_schedule_timestamp', sortable: true },
        { name: 'de_earning', label: 'De Earnings', field: 'de_earning', sortable: true },
        { name: 'total_distance', label: 'Total Distance', field: 'total_distance', sortable: true },
        { name: 'total_deliveries', label: 'Total Deliveries', field: 'total_deliveries', sortable: true },
      ],
      data:[],
      today_date:'',
      yesterday_date:''
...
this.gettodaydata();
      ...
      headers: {
       ...
       axios.post('https://chotabeta.app/dev/testenv/api/vendor/get-today-orders',
       {
      ...
      .then(function (response) {
        ...
        vm.data = response.data.rating_review_sort;
