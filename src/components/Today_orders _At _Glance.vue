  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'GST', align: 'center', label: 'GST', field: 'GST', sortable: true},
        { name: 'Order_count', align: 'center', label: 'Orders Count', field: 'Order_count', sortable: true},
...
this.gettabledata();
      ...
      headers: {
       ...
       axios.get('https://chotabeta.app/dev/testenv/api/today-orders-glance',config)
