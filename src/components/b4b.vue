  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'child_orders_count', align: 'center', label: 'child Orders cCount', field: 'child_orders_count', sortable: true},
...
this.gettabledata();
      ...
      headers: {
       ...
       axios.get('https://www.stackroger.com/api/vendor/b4b-vendor-orders',
       {
      ...
      .then(function (response) {
        ...
        vm.data = response.data.b4b_orders;
