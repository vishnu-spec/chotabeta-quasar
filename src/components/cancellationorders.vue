  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'from_location', align: 'center', label: 'From Location', field: 'from_location', sortable: true},
...
this.gettodaydata();
      ...
      headers: {
       ...
       axios.post('https://chotabeta.app/dev/testenv/api/admin/get-cancellation-orders',
       {
      ...
      .then(function (response) {
        ...
        vm.data = response.data.cancellation_details;
