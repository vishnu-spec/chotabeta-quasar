  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'from_name', align: 'center', label: 'From Name', field: 'from_name', sortable: true},
        { name: 'order_id', align: 'center', label: 'Order Id', field: 'order_id', sortable: true},
        { name: 'multidrop_order_id', align: 'center', label: 'multidrop order id', field: 'multidrop_order_id', sortable: true},
        { name: 'no_of_deliveries', align: 'center', label: 'No Of Deliveries', field: 'no_of_deliveries', sortable: true},
        { name: 'created_at', align: 'center', label: 'created at', field: 'created_at', sortable: true},
        { name: 'vendor_name', align: 'center', label: 'Vendor Name', field: 'vendor_name', sortable: true},
...
this.gettabledata();
      ...
      headers: {
       ...
       axios.get('https://chotabeta.app/dev/testenv/api/get-multi-drop-orders',config)
      .then(function (response) {
        // handle success
        vm.loading = false;
        console.log(response,"getstateeee");
        vm.data = response.data.ongoing_orders;
