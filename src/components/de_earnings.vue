  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'delivery_person_id', align: 'center', label: 'DE ID', field: 'delivery_person_id', sortable: true},
        { name: 'name', align: 'center', label: 'Pilot Name', field: 'name', sortable: true},
        { name: 'num_of_deliveries', align: 'center', label: 'No. Of Deliveries', field: 'num_of_deliveries', sortable: true},
        { name: 'total_distance_travelled', align: 'center', label: 'Distance Travelled (Km)', field: 'total_distance_travelled', sortable: true},
        { name: 'delivery_person_earning', align: 'center', label: 'De Earnings', field: 'delivery_person_earning', sortable: true},
      ],
      data:[],
      today_date:'',
      yesterday_date:''
...
this.gettodaydata();
      ...
      headers: {
       ...
       axios.post('https://chotabeta.app/dev/testenv/api/de-earnings',
       {
