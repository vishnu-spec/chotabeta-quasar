  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'total_count', align: 'center', label: 'total_count', field: 'total_count', sortable: true},
        { name: 'today_count', align: 'center', label: 'today_count', field: 'today_count', sortable: true},
        { name: 'yesterday_count', align: 'center', label: 'yesterday_count', field: 'yesterday_count', sortable: true},
        { name: 'month_count', align: 'center', label: 'month_count', field: 'month_count', sortable: true},
      ],
      data:'',
    }
  },
...
this.gettabledata();
      ...
      .then(function (response) {
        ...
        vm.data = response.data.city_based;
