  ...
  <q-circular-progress
    ...
    <q-table
     class="my-sticky-header-table"
      :filter="filter"
      :loading="loading"
      title="Manual Orders Restricted"
      :data="data"
      :columns="columns"
      row-key="index"
      style="height:650px;"
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'Cancellation_Fee', align: 'center', label: 'Cancellation Fee', field: 'Cancellation_Fee', sortable: true},
...
this.gettabledata();
      ...
      headers: {
       ...
       axios.get('https://chotabeta.app/dev/testenv/api/manual-restricted-orders',config)
