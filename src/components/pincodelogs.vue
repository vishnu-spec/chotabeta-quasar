  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'lng', align: 'center', label: 'LNG', field: 'lng', sortable: true},
...
//       }
//     }
//        axios.post('https://chotabeta.app/dev/testenv/api/rep/pincode-logs',
//        {
...
//         vm.data = response.data.pincode_logs;
