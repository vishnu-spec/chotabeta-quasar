  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'from_id', align: 'center', label: 'From ID', field: 'from_id', sortable: true},
        { name: 'to_id', align: 'center', label: 'TO ID', field: 'to_id', sortable: true},
...
//       }
//     }
//        axios.post('https://chotabeta.app/dev/testenv/api/rep/get-order-rating',
//        {
...
//         vm.data = response.data.rating_review;
