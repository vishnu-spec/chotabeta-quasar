  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'OrderId', align: 'center', label: 'OrderId', field: 'OrderId', sortable: true},
        ...
        { name: 'timestamp', align: 'center', label: 'Timestamp', field: 'timestamp', sortable: true},
        { name: 'ops_claim_time', align: 'center', label: 'Ops Claim Time', field: 'ops_claim_time', sortable: true},
        { name: 'ops_status_update', align: 'center', label: 'Ops Status Update', field: 'ops_status_update', sortable: true},
...
this.gettabledata();
      ...
      headers: {
       ...
       axios.get('https://chotabeta.app/dev/testenv/api/today-sla-glance',config)
